    ...
    public class MovieViewModel : INotifyPropertyChanged
    {
        ...
        {           
            ObservableCollection<MovieItems> movieItems = new ObservableCollection<MovieItems>
            {
                ...
                new MovieItems { MovieName = "Action", MovieImage = @"/Resources/Icons/clap_icon.png" },
                new MovieItems { MovieName = "Thriller", MovieImage = @"/Resources/Icons/clap_icon.png" },
                new MovieItems { MovieName = "Adventure", MovieImage = @"/Resources/Icons/clap_icon.png" },
                new MovieItems { MovieName = "Drama", MovieImage = @"/Resources/Icons/clap_icon.png" },
                new MovieItems { MovieName = "Fantasy", MovieImage = @"/Resources/Icons/clap_icon.png" },
                new MovieItems { MovieName = "Mystery", MovieImage = @"/Resources/Icons/clap_icon.png" }
