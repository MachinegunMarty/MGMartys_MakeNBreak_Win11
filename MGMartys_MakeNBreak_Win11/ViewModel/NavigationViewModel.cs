    ...
    class NavigationViewModel : INotifyPropertyChanged
    {
        ...
        public NavigationViewModel()
        {
            ...
            ObservableCollection<MenuItems> menuItems = new ObservableCollection<MenuItems>
            {
                ...
                new MenuItems { MenuName = "Documents", MenuImage = @"/Resources/Icons/Document_Icon.png" },
                new MenuItems { MenuName = "Downloads", MenuImage = @"/Resources/Icons/Download_Icon.png" },
                new MenuItems { MenuName = "Pictures", MenuImage = @"/Resources/Icons/Images_Icon.png" },
                new MenuItems { MenuName = "Music", MenuImage = @"/Resources/Icons/Music_Icon.png" },
                new MenuItems { MenuName = "Movies", MenuImage = @"/Resources/Icons/Movies_Icon.png" },
                new MenuItems { MenuName = "Trash", MenuImage = @"/Resources/Icons/Trash_Icon.png" }
            };
