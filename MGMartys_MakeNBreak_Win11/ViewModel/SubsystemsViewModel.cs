...
namespace MGMartys_MakeNBreak_Win11.ViewModel
{
    public class SubsystemsViewModel : INotifyPropertyChanged
    {
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d Ubuntu";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d Debian";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d kali-linux";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d SLES-12";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d SLES-15";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d Ubuntu-18.04";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d Ubuntu-20.04";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d OracleLinux_8_5";
        ...
        {
            string Exe = "wt.exe";
            string Arguments = @"wsl --install - d OracleLinux_7_9";
